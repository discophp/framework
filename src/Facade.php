...
abstract class Facade {
     ...
     * @param mixed     $args The arguments that were passed to the original $method.
     *
     * @return mixed    Return the result of the method call on the resolved instance from the IoC container.
     */
    public static function __callStatic($method, $args){
        return \Disco\App::instance()->handle(static::returnFacadeId(), $method, $args);
    }//callStatic
    ...
    public static function instance(){
        return \Disco\App::instance()[static::returnFacadeId()];
    }//instance
